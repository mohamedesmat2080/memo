...
public:
    ...
    int Render_0(int x, int y, byte alpha);
    int Render_1(int x, int y, byte alpha);
...
public:
    ...
    int N00000D1C; //0x0050
    int N00000D1D; //0x0054
    int N00000D1E; //0x0058
    int N00000D1F; //0x005C
    int N00000D20; //0x0060
    int N00000D21; //0x0064

...
GFX_IMPLEMENT_DYNCREATE(CIFExtQuickSlotCustom, CIFWnd)
GFX_BEGIN_MESSAGE_MAP(CIFExtQuickSlotCustom, CIFWnd)
ONG_COMMAND(11, &CIFExtQuickSlotCustom::On_BtnClick)
ONG_COMMAND(12, &CIFExtQuickSlotCustom::On_BtnClick)
ONG_COMMAND(13, &CIFExtQuickSlotCustom::On_BtnClick)
ONG_COMMAND(14, &CIFExtQuickSlotCustom::On_BtnClick)

ONG_COMMAND(303, &CIFExtQuickSlotCustom::On_BtnClickDown)
ONG_COMMAND(304, &CIFExtQuickSlotCustom::On_BtnClickUp)

GFX_END_MESSAGE_MAP()

CIFExtQuickSlotCustom::CIFExtQuickSlotCustom() {
    OnOffBtn = 0;
    OptBtn = NULL;
    HoriBtn = NULL;
    VertBtn = NULL;
...
void CIFExtQuickSlotCustom::EnsureSlots() {
    for (int i = 0; i < 10; i++) {
...
bool CIFExtQuickSlotCustom::OnCreate(long ln) {

    CIFWnd::OnCreate(ln);
    //This Type 1

    m_IRM.LoadFromFile("clientlibrary\\resinfo\\ifextquickslotcustom.txt");
    ...
    for (int i = 0; i < 10; i++) {
        ...
        m_IRM.GetResObj<CIFStatic>(200+i, 1)->TB_Func_9(150);
        m_IRM.GetResObj<CIFStatic>(200+i, 1)->m_FontTexture.sub_8B4750(7);
    }
    for (int i = 0; i < 40; i++) {
        ...
        myslots[i]->m_pMySlot->m_pSlot->SetSlot(101 + i);
    }
    UpdateBarStyle(1);
    ...
    this->m_IRM.GetResObj(209, 1)->SetText(L"SP+0");
    this->m_IRM.GetResObj(208, 1)->SetText(L"SP+9");
    this->m_IRM.GetResObj(207, 1)->SetText(L"SP+8");
    this->m_IRM.GetResObj(206, 1)->SetText(L"SP+7");
    this->m_IRM.GetResObj(205, 1)->SetText(L"SP+6");
    this->m_IRM.GetResObj(204, 1)->SetText(L"SP+5");
    this->m_IRM.GetResObj(203, 1)->SetText(L"SP+4");
    this->m_IRM.GetResObj(202, 1)->SetText(L"SP+3");
    this->m_IRM.GetResObj(201, 1)->SetText(L"SP+2");
    this->m_IRM.GetResObj(200, 1)->SetText(L"SP+1");
...
int LastBarStylex;
void CIFExtQuickSlotCustom::On_BtnClick() {
    g_pCGInterface->m_IRM.GetResObj<CIFExtQuickSlotCustomOption>(CustomQuickSlotOption, 1)->SetCheckBoxState(3);
    int id = GetCurrentEventMsgCtrlId();
    switch (id) {
        case GDR_EXT_QUICKSLOT_OPT_BTN: {
            if (!g_pCGInterface->m_IRM.GetResObj<CIFExtQuickSlotCustomOption>(CustomQuickSlotOption, 1)->IsVisible()) {
                g_pCGInterface->m_IRM.GetResObj<CIFExtQuickSlotCustomOption>(CustomQuickSlotOption, 1)->ShowGWnd(true);
                g_pCGInterface->m_IRM.GetResObj<CIFExtQuickSlotCustomOption>(CustomQuickSlotOption, 1)->ResetPosition();

            }
        } break;
        case GDR_EXT_QUICKSLOT_HORI_BTN: /// yataya çevir
        {
            g_pCGInterface->m_IRM.GetResObj<CIFExtQuickSlotCustomOption>(CustomQuickSlotOption, 1)->QUICKSLOT_OPT_YATAY = true;
            if (g_pCGInterface->m_IRM.GetResObj<CIFExtQuickSlotCustomOption>(CustomQuickSlotOption, 1)->QUICKSLOT_OPT_DOUBLELINE_CHECKBOX) {
                UpdateBarStyle(2);
            }
            else {
                UpdateBarStyle(1);
            }
            g_pCGInterface->m_IRM.GetResObj<CIFExtQuickSlotCustomOption>(CustomQuickSlotOption, 1)->SetCheckBoxState(2);
        } break;
        case GDR_EXT_QUICKSLOT_VERT_BTN: /// dikeye çevir
        {
            g_pCGInterface->m_IRM.GetResObj<CIFExtQuickSlotCustomOption>(CustomQuickSlotOption, 1)->QUICKSLOT_OPT_YATAY = false;
            if (g_pCGInterface->m_IRM.GetResObj<CIFExtQuickSlotCustomOption>(CustomQuickSlotOption, 1)->QUICKSLOT_OPT_DOUBLELINE_CHECKBOX) {
                UpdateBarStyle(4);
            }
            else {
...
void CIFExtQuickSlotCustom::UpdateBarStyle(int Type) { /// horiz yatay amk
        ...
        case 1: /// yatay tek satır
        {
            if (SlotsOpened)
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    m_IRM.GetResObj<CIFStatic>(200+i, 1)->MoveGWnd(nSlotPosX + (psMagicCube.x + 43), psMagicCube.y+26);
                    m_IRM.GetResObj<CIFStatic>(200+i, 1)->ShowGWnd(true);
                    m_IRM.GetResObj<CIFStatic>(200+i, 1)->BringToFront();
                    nSlotPosX += 36;
                }
            ...
            else
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    pBoards->TB_Func_13("interface\\quick_slot\\qsl_hriz01_slot_tile.ddj", 1, 1);
                    m_IRM.GetResObj<CIFStatic>(200+i, 1)->MoveGWnd(nSlotPosX + (psMagicCube.x + 43), psMagicCube.y+26);
                    m_IRM.GetResObj<CIFStatic>(200+i, 1)->ShowGWnd(false);
        ...
        case 2: /// dikey iki satır
        {
            ...
            if (SlotsOpened) {
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    {
                        pBoards->ShowGWnd(false);
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->MoveGWnd(nSlotPosX + (psMagicCube.x - 149), psMagicCube.y + 63);
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->ShowGWnd(true);
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->BringToFront();
                    }
                    else
                    {
                        ...
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->MoveGWnd(nSlotPosX + (psMagicCube.x + 31), psMagicCube.y + 26);
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->ShowGWnd(true);
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->BringToFront();
                    }
                    nSlotPosX += 36;
        ...
        case 3: /// dikey tek satır
        {
            if (SlotsOpened) {
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    m_IRM.GetResObj<CIFStatic>(200+i, 1)->MoveGWnd(psMagicCube.x + 5,  nSlotPosY + (psMagicCube.y + 66));
                    m_IRM.GetResObj<CIFStatic>(200+i, 1)->ShowGWnd(true);
                    m_IRM.GetResObj<CIFStatic>(200+i, 1)->BringToFront();
                    nSlotPosY += 36;
                }
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    pBoards->ShowGWnd(false);
                    pBoards->TB_Func_13("interface\\quick_slot\\qsl_vrtl01_slot_tile.ddj", 1, 1);
                    m_IRM.GetResObj<CIFStatic>(200+i, 1)->MoveGWnd(psMagicCube.x + 5,  nSlotPosY + (psMagicCube.y + 63));
                    m_IRM.GetResObj<CIFStatic>(200+i, 1)->ShowGWnd(false);
                    nSlotPosY += 36;
                }
            }
        ...
        case 4: /// dikey amk çift satır
        {
            if (SlotsOpened) {
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    {
                        pBoards->ShowGWnd(false);
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->MoveGWnd(psMagicCube.x + 41, nSlotPosY + (psMagicCube.y - 127));
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->ShowGWnd(true);
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->BringToFront();
                    }
                    else
                    {
                        ...
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->MoveGWnd(psMagicCube.x + 5, nSlotPosY + (psMagicCube.y + 53));
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->ShowGWnd(true);
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->BringToFront();
                    }
                    nSlotPosY += 36;
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    {
                        pBoards->ShowGWnd(false);
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->MoveGWnd(psMagicCube.x + 41, nSlotPosY + (psMagicCube.y - 123));
                        m_IRM.GetResObj<CIFStatic>(200+i, 1)->ShowGWnd(false);
                    }
                    else
                    {
...
void CIFExtQuickSlotCustom::OnUpdate() {
    if (g_pCGInterface->m_IRM.GetResObj<CIFExtQuickSlotCustomOption>(CustomQuickSlotOption, 1)->mainx != g_CGame->GetRes().res->height
        && g_pCGInterface->m_IRM.GetResObj<CIFExtQuickSlotCustomOption>(CustomQuickSlotOption, 1)->mainy != g_CGame->GetRes().res->width) {
        int PosX = 0, PosY = 0;
...
void CIFExtQuickSlotCustom::ResetPosition() {
...
void CIFExtQuickSlotCustom::On_BtnClickDown() {
    ...
    if (ActivePageNo > 1) {
        ...
        else if(ActivePageNo == 2)
        {
            hotkey->SetText(L"F6");
        }
        else if(ActivePageNo == 3)
        {
            hotkey->SetText(L"F7");
        }
        else if(ActivePageNo == 4)
        {
            hotkey->SetText(L"F8");
        }
...
void CIFExtQuickSlotCustom::On_BtnClickUp() {
    // Aktif sayfa numarasını arttır
    if (ActivePageNo < 4) { // 5 sayfa olduğunu varsayalım, gerekirse sayıyı değiştirin
        ActivePageNo++;
        if(ActivePageNo == 1)
        {
            hotkey->SetText(L"F5");
...
void CIFExtQuickSlotCustom::UpdateSlots() {
...
void CIFExtQuickSlotCustom::UseViaSpace(int Key)
{
    int slotIndex;
    if (Key == 0) {
        slotIndex = 9;
    ...
    int adjustedIndex = (ActivePageNo - 1) * 10 + slotIndex;

    if (adjustedIndex >= 0 && adjustedIndex < 40) {
        if (myslots[adjustedIndex]->m_pMySlot->m_pSlot != NULL) {
            if (myslots[adjustedIndex]->m_pMySlot->m_pSlot->ItemInfo != NULL || myslots[adjustedIndex]->m_pMySlot->m_pSlot->m_SkillID != 0) {
                myslots[adjustedIndex]->UseItem(myslots[adjustedIndex]->m_pMySlot->m_pSlot->GetSlot());
            }
        }
    }
}

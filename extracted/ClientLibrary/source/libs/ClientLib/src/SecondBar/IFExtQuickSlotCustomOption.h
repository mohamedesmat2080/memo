...
class CIFExtQuickSlotCustomOption : public CIFMainFrame {
GFX_DECLARE_DYNCREATE(CIFExtQuickSlotCustomOption)
GFX_DECLARE_MESSAGE_MAP(CIFExtQuickSlotCustomOption)
    enum {

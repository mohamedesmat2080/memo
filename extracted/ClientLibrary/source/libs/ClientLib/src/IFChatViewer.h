...
public:
    ...
    /// \address 007ab5c0
    void SetLastWhisperedWith(std::n_wstring &wstrName);

    /// \address 007acfd0
    void AddWhisperTargetToList(std::n_wstring &wstrName);
...
private:
    ...
    CIFWhisperList *m_pWhisperList; //0x0498
...
private:
    ...
    std::n_wstring N00009C82; //0x04B0
...
public:
    BEGIN_FIXTURE()
        ...
        ENSURE_OFFSET(m_pWhisperList, 0x0498);

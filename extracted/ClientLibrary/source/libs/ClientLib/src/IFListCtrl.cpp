...
void CIFListCtrl::FUN_00638d20(unsigned char p1){
    reinterpret_cast<void*(__thiscall*)(CIFListCtrl*, unsigned char)>(0x00638d20)(this, p1);
}
/// get selected Index 00638c50
...
void CNetProcessIn::RegisterPacketHandlers() {
    ...
    //m_handlers.insert(std::make_pair(0x180B, &CNetProcessIn::On180B));
}
...
//void CNetProcessIn::On180B(CMsgStreamBuffer& msg) {
//    UINT16 strLen;
//    msg.Read(&strLen, 2);
//    char* itemChatLinkKey = new char[strLen];
//    msg.Read(itemChatLinkKey, strLen);
...
//    ChatItemInfoList[std::string(itemChatLinkKey).c_str()] = info;
//}
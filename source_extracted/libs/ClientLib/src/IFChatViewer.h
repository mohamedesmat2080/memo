...
public:
    ...
    void emojiHandler();
    int getWidth(std::n_wstring str,CIFListCtrl* pList,std::string emojiCode,int index);
    void renderEmoji(int Index,int totalIndexes,int width,int height,int usedIndexes,std::string emoji,int emojiIndex);
    void hideEmojis();
    void hideEmojisByLine(int index);
private:

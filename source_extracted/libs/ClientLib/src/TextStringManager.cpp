...
std::wstring* CTextStringManager::GetStringByNameStrID(const std::wstring &NameStrID)
{
    return reinterpret_cast <std::wstring * (__thiscall*)(CTextStringManager*, const std::wstring &)>(0x008C9BB0)(this, NameStrID);
}

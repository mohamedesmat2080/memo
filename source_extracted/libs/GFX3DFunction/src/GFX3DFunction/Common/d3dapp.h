...
protected:
    ...
    virtual HRESULT ToggleFullscreen(); /* joymax made this virtual to override it in CGFXVideo3d */
    HRESULT ForceWindowed();
    HRESULT UserSelectNewDevice();
    void    Cleanup3DEnvironment();
    HRESULT Render3DEnvironment();
    virtual HRESULT AdjustWindowForChange(); // untouched by joymax
    virtual void UpdateStats(); // possibly untouched by joymax, (DX_Timer got inlined)
